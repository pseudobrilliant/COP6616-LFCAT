...
public class Treap<T> implements IList<T> {
    ...
    {
        return getIndexByValue(root.value);
    }
    ...
    public static class JavaCompatibleArrayList<T> extends java.util.AbstractList<T> implements java.util.RandomAccess {
        ...
        private Treap<T> list = null;

        public JavaCompatibleArrayList(Treap<T> list) {
            this.list = list;
        }
    ...
    protected static class TreePrinter {
        ...
        public static <T> String getString(Treap<T> tree) {
            if (tree.root == null)
