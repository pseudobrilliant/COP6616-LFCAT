...
public class BinarySearchTree<T extends Comparable<T>> implements ITree<T> {
    ...
    public BinarySearchTree(BinarySearchTree<T> _orig)
    {
        this.modifications = _orig.modifications;
        this.creator = _orig.creator;
    }
    /**
    ...
    protected static class Node<T extends Comparable<T>> {
        ...
        Node<T> copy(Node _parent)
        {
            Node<T> newMe = new Node<T>(_parent, this.id);
