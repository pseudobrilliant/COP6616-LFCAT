package com.samanthadoran;

/* URL: https://github.com/samanthadoran/Treap/blob/master/Treap.java
...
public class Treap <Anytype extends Comparable<Anytype>>
{
    ...
    private Node <Anytype> insert(Node <Anytype> workingNode, Anytype data, int priority)
    {
        ...
        {
            throw new IllegalArgumentException("Value already exists in Treap!");
        }
    ...
    public boolean add(Anytype data, int priority)
    {
    ...
    private Node<Anytype> delete(Node<Anytype> workingNode, Anytype data)
    {
        ...
        if (workingNode == null)
        {
            throw new IllegalArgumentException("Value does not exist in treap!");
        }
